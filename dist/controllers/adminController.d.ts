...
export declare const updateSurveyStatus: (req: AdminRequest, res: Response) => Promise<any>;
...
export declare const updateRewardStatus: (req: AdminRequest, res: Response) => Promise<any>;
export declare const getSurveyResponses: (req: AdminRequest, res: Response) => Promise<any>;
...
export declare const processCancellationRequest: (req: AdminRequest, res: Response) => Promise<any>;
...
export declare const processWithdrawalRequest: (req: AdminRequest, res: Response) => Promise<any>;
