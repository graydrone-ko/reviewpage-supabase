...
export declare const approveWithdrawal: (req: AuthRequest, res: Response) => Promise<any>;
export declare const rejectWithdrawal: (req: AuthRequest, res: Response) => Promise<any>;
